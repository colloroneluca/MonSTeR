...
# BASE PATH
CONF.ROOT = "/media/shiva/lucac_ssd/hsi/models/Pointnet2.ScanNet" # TODO change this
CONF.SCANNET_DIR =  "/media/shiva/lucac_ssd/hsi/datasets/scans" # TODO change this
